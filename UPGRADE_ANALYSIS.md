...
4. ❌ **Отложено:** `react-helmet-async` 1 → 2 (оказалось высокий риск - 379 TS ошибок)

### ⏸️ Отложено до лучших времён:

5. 🟡 `react-router-dom` 6 → 7 (средний риск, 1 неделя)
6. 🟡 `express` 4 → 5 (средний риск, 1-2 недели) - **STABLE с января 2025**
7. 🟡 `react` 18 → 19 (высокий риск, 2-3 недели) - **STABLE с декабря 2024**
