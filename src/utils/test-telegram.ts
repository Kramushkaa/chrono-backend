...
async function testTelegramNotifications() {
  ...
  try {
    ...
    await telegramService.notifyNewRegistration('test@example.com', 'testuser', 'Test User');
    ...
    await telegramService.notifyPersonCreated(
      'Тестовая Личность',
      'user@test.com',
      'pending',
      'test-person-id'
    ...
    await telegramService.notifyPersonEditProposed(
      'Известная Личность',
      'editor@test.com',
      'existing-person-id'
    );
    ...
    await telegramService.notifyPersonReviewed(
      'Тестовая Личность',
      'approve',
      'moderator@test.com',
      'test-person-id'
    ...
    await telegramService.notifyAchievementCreated(
    ...
    await telegramService.notifyAchievementReviewed(
      'Открыл Америку',
      1492,
      'approve',
      'moderator@test.com'
    ...
    await telegramService.notifyPeriodCreated(
      'ruler',
      1533,
      1584,
      'user@test.com',
